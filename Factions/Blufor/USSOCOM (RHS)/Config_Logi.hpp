	...
	bluforBuyables[] = {
		...
		},
		{
			"Heavy Vehicles",
			{
				...
				{"rhsusf_m1a2sep1tuskiid_usarmy", {400,200,400}, "DT_globalReputation > 50 && {call DT_fnc_getMissionProgress > 0.3}"},
				{"rhsusf_m1a2sep2d_usarmy", {400,200,400}, "DT_globalReputation > 50 && {call DT_fnc_getMissionProgress > 0.3}"},
		...
		},
		{
			"Air Vehicles",
			{
				...
				{"RHS_MELB_MH6M", {150,25,100}, "missionNamespace getVariable ['DT_canPurchaseAir',false] && {count (missionNamespace getVariable ['DT_currentHelicopters',[]]) < DT_maxHelicopterCount}"},                       // UH-1Ys
				{"RHS_MELB_AH6M", {200,100,150}, "missionNamespace getVariable ['DT_canPurchaseAir',false] && {count (missionNamespace getVariable ['DT_currentHelicopters',[]]) < DT_maxHelicopterCount}"},
				{"RHS_AH64D", {250,200,250}, "missionNamespace getVariable ['DT_canPurchaseAir',false] && {count (missionNamespace getVariable ['DT_currentHelicopters',[]]) < DT_maxHelicopterCount}"},
				{"RHS_UH60M_d", {150,50,100}, "missionNamespace getVariable ['DT_canPurchaseAir',false] && {count (missionNamespace getVariable ['DT_currentHelicopters',[]]) < DT_maxHelicopterCount}"},
				{"RHS_UH60M_ESSS_d", {200,125,100}, "missionNamespace getVariable ['DT_canPurchaseAir',false] && {count (missionNamespace getVariable ['DT_currentHelicopters',[]]) < DT_maxHelicopterCount}"},
				{"RHS_CH_47F_10", {175,50,125}, "missionNamespace getVariable ['DT_canPurchaseAir',false] && {count (missionNamespace getVariable ['DT_currentHelicopters',[]]) < DT_maxHelicopterCount}"},
				{"RHS_CH_47F_10_cargo", {175,25,125}, "missionNamespace getVariable ['DT_canPurchaseAir',false] && {count (missionNamespace getVariable ['DT_currentHelicopters',[]]) < DT_maxHelicopterCount}"},
