class Dynamic_Groups { //format: {"Group Name",{"Group","Roles","Matching","Role","Configs"},"Conditions for the group to be shown","SW TFAR/ACRE Freq","LR TFAR/ACRE Freq"}
	...
	group_setup[] = {
		...
		{"Beta",{"squadlead","teamlead","medic","rifleman","rifleman","teamlead","engineer","rifleman","rifleman"},"count playableUnits > 5","51","31"},
		{"Gamma",{"squadlead","teamlead","medic","rifleman","rifleman","teamlead","engineer","rifleman","rifleman"},"count playableUnits > 15","52","31"},
		{"Delta",{"squadlead","teamlead","medic","rifleman","rifleman","teamlead","engineer","rifleman","rifleman"},"count playableUnits > 25","53","31"},
		{"Athena",{"pilot","pilot"},"true","60","32"},
		{"Apollo",{"pilot","pilot"},"count playableUnits > 10","60","32"},
		{"Zeus",{"commander","crewman","crewman"},"true","61","33"},
		{"Hera",{"commander","crewman","crewman"},"count playableUnits > 14","61","33"},
