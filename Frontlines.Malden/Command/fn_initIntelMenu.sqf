...
private _intelActions = [
	...
	["Opfor Scanner",ceil ((count (groups east)) / 2),"","[] call DT_fnc_opforScanner","Utilise some of our intelligence to detect all opfor groups and mark them on the map for 5 minutes.<br/>The intel cost of this action increases with the number of opfor units alive."]
];
